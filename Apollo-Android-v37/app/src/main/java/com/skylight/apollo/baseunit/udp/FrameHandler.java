...
//			packageIndex =  packageIndex + currentCountIndex & 0xffffffff;
			int packageLens  = currentCountIndex == totalCount - 1 ? frameLength % (PACKET_LENS - HEAD_LENGTH):PACKET_LENS - HEAD_LENGTH;
//			endPosition = currentCountIndex == totalCount - 1 ? (currentCountIndex + 1) * PACKET_LENS -1: dataLength -1;
...
//			if (isFirst) {
//			CmLog.e("---------------frameInfo:|" + currentCountIndex + "|" + frameLength + "|" + startPosition + "|" + packageIndex + "|" + packageLens + "|" + frameIndex + "|" + channel + "|" + startIndex + "|" + totalCount + "|" + IBPtype);
//				isFirst = false;
//			}
...
//		if (IBPtype == 0X20)CmLog.e("----I frame out");
		PacketDateBean packetDateBean = new PacketDateBean(outputData,packageIndex,frameIndex,repeatTime);
		if(packageOutListener != null)packageOutListener.onPacketOut(packetDateBean);
	}
