...
/**
 * Created by pangyou on 2017/6/15.
 */

public class AudioThread2 {
    private final String TAG = "AudioThread2";
    ...
    public AudioThread2(String filePath){
...
//                        }
    ...
    public void startThread(){
        threadRun=true;
        threadPool.submit(new VideoPlayerThread());
    }
